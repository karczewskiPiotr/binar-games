 ...
 const sortEventsOwned = (a, b) =>{
  ...
  return(
    <>
      ...
      {state.loading
        ? <LoadingIcon/>
        : state.events_owned.sort(sortEventsOwned).map(
          event => <Event key={event.id} fetchEvents={fetchEvents} event={event}/>)
      }
      ...
      {state.loading
        ? <LoadingIcon/>
        : state.events.sort(sortEvents).map(
          event => <Event key={event.id} fetchEvents={fetchEvents} event={event}/>)
      }
    </>
  );
